...
echo '<title>Profile des utilisateurs</title>';
...
?>
    <div class="wrapped">
        <?php
    require_once "include/useractif.php";
    require_once "include/userinactif.php";
    
    // Fermeture de connexion au bon endroit
    if(isset($link) && is_a($link, 'mysqli')) {
        mysqli_close($link);
    }
    ?>
</div>
